...
\title{\huge AmyloGram: analysis and prediction of amyloids using n-grams}
...
\begin{figure} 
\includegraphics[width=0.86\columnwidth]{static_figure/ngram_scheme_poster.eps}
\end{figure}
...
<<echo = FALSE,message=FALSE,fig.align='center',fig.width=14,fig.height=5.9,warning=FALSE>>=
...
ggplot(amyloids_plot, aes(x = len_range, y = AUC_mean)) +
  geom_boxplot(outlier.color = "grey", outlier.shape = 1, outlier.size = 4) +
...
<<echo = FALSE,message=FALSE,fig.align='center',fig.width=14,fig.height=6.1,warning=FALSE>>=
...
Find our poster online: \url{http://github.com/michbur/BIO2016}
